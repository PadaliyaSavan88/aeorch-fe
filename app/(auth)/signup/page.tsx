...
function SignupForm() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    setLoading(true);
    try {
      const { data } = await authApi.register(name, email, password, refCode || undefined);
      ...
      <div className="w-full max-w-md">
        <div className="card p-8">
          ...
          <p className="text-slate-500 text-sm mb-8">
            Start with 20 free page credits — no card required.
          </p>
          ...
          <a href={GOOGLE_AUTH_URL} className="btn-secondary w-full justify-center gap-3">
            <GoogleIcon />
